    ...
    public static void main(String[] args) {
        ...
        try {
           ...
           bg2=ImageIO.read(Rash.class.getResource("../images/73933_20160911154803859_20160911155318472.jpg"));
            ...
            bot[0][0]=ImageIO.read(Rash.class.getResource("../images/bota25.png"));
            bot[0][1]=ImageIO.read(Rash.class.getResource("../images/bota50.png"));
            bot[0][2]=ImageIO.read(Rash.class.getResource("../images/bota75.png"));
            bot[0][3]=ImageIO.read(Rash.class.getResource("../images/bota100.png"));
            bot[0][4]=ImageIO.read(Rash.class.getResource("../images/bota125.png"));


            bot[1][0]=ImageIO.read(Rash.class.getResource("../images/botb25.png"));
            bot[1][1]=ImageIO.read(Rash.class.getResource("../images/botb50.png"));
            bot[1][2]=ImageIO.read(Rash.class.getResource("../images/botb75.png"));
            bot[1][3]=ImageIO.read(Rash.class.getResource("../images/botb100.png"));
            bot[1][4]=ImageIO.read(Rash.class.getResource("../images/botb125.png"));


            bot[2][0]=ImageIO.read(Rash.class.getResource("../images/botc25.png"));
            bot[2][1]=ImageIO.read(Rash.class.getResource("../images/botc50.png"));
            bot[2][2]=ImageIO.read(Rash.class.getResource("../images/botc75.png"));
            bot[2][3]=ImageIO.read(Rash.class.getResource("../images/botc100.png"));
            bot[2][4]=ImageIO.read(Rash.class.getResource("../images/botc125.png"));


            bot[3][0]=ImageIO.read(Rash.class.getResource("../images/botd25.png"));
            bot[3][1]=ImageIO.read(Rash.class.getResource("../images/botd50.png"));
            bot[3][2]=ImageIO.read(Rash.class.getResource("../images/botd75.png"));
            bot[3][3]=ImageIO.read(Rash.class.getResource("../images/botd100.png"));
            bot[3][4]=ImageIO.read(Rash.class.getResource("../images/botd125.png"));


            hero=ImageIO.read(Rash.class.getResource("../images/hero125.png"));
            rail=ImageIO.read(Rash.class.getResource("../images/manz.png"));
            dead=ImageIO.read(Rash.class.getResource("../images/maxresdefault.jpg"));
